...
mod tests {
    ...
    use super::*;
    use crate::{coordinate::CoordinateSpec, facet::FacetSpec, layer::LayerSpec, mapping::Mapping, scale::ScaleSpec};
    ...
    fn compiles_point_bar_text() {
        ...
        let text = compile_plot(&PlotSpec::new(table).mapping(mapping).layer(LayerSpec::geom_text()), CompileOptions::golden())
            .unwrap();
